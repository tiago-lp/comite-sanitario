...
export default function DonationMoreMenu({id, donation}) {
  ...
  return (
    <>
      ...
      >
        <MenuItem sx={{ color: 'text.secondary' }} onClick={() => {dispatch(deleteDonationRequest(id))}}>
          <ListItemIcon>
        ...
        <MenuItem component={RouterLink} to="#" sx={{ color: 'text.secondary' }} onClick={handleClickOpen}>
          <ListItemIcon>
      ...
      <DonationForm open={open} donation={donation} edit handleClose={handleClose} />
    </>
  );
}
